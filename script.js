...
(() => {
  ...
  const CONFIG = { topicsUrl: 'topics.json', batchSize: 4 };
  ...
  function renderCard(topic) {
    ...
    const card = el('article', { class: 'card', 'aria-labelledby': heading }, [
    ...
    return el('section', { class: 'stage topic-entry', 'data-topic-id': key }, [card, el('div', { class: 'envelope-wrap' }, [envelope, el('p', { class: 'env-hint', text: 'a little further inside', 'aria-hidden': 'true' })])]);
  }
